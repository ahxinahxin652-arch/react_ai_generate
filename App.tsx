...
const App: React.FC = () => {
  ...
  useEffect(() => {
    // setGenerationState({
    //     isLoading: false,
    //     resultUrl: 'https://webstatic.aiproxy.vip/output/20260127/56366/ee37d85d-5aca-4f84-8cac-024e10aaff57.jpg',
    //     error: null
    // });
  ...
  const handleGenerate = async () => {
    ...
    try {
      ...
      if (!result.success) {
        // 沿用双通道返回结果
        throw new Error(result.error || '通道1、2均已生成失败');
      }
